    ...
    <main className="authPage">
      ...
      <div className="hero" style={{ background: "linear-gradient(90deg, #8b5cf6, #ef4444)" }}>
        ...
        <div className="heroRow">
          <div>
            <div className="heroKicker">Join Agile Hostile</div>
            <div className="heroTitle">Create your account</div>
            <div className="heroSub">Climb the corporate ladder and survive the AIs.</div>
          </div>
        </div>
      </div>
      ...
      <section className="authWrap">
        <div className="authCard">
          <h3 className="cardTitle">Sign up with</h3>
          <OAuthButtons />
